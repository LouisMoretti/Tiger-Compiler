...
#define TOKEN(Type) parser::make_##Type(td.location_)

#define TOKEN_VAL(Type, Value) parser::make_##Type(Value, td.location_)

#define CHECK_EXTENSION()                                                      \
  do                                                                           \
    {                                                                          \
      if (!td.enable_extensions_p_)                                            \
        td.error_ << misc::error::error_type::scan << td.location_             \
                  << ": invalid identifier: `" << misc::escape(text())         \
                  << "'\n";                                                    \
  } while (false)
